...
Pod::Spec.new do |s|
  ...
  s.source            = { :http => "https://kisiodigital.jfrog.io/kisiodigital/ios-release/expert/1.4.6/NavitiaSDK.framework.zip", :sha1 => 'f6b7054aecf1da9467196ad82902346ffb2ceb0c' }
  s.platform          = :ios, "10.0"
