...
Pod::Spec.new do |s|
  ...
  s.source            = { :http => "https://kisiodigital.jfrog.io/kisiodigital/ios-release/expert/1.4.5/NavitiaSDK.framework.zip", :sha1 => '69b87f3b347330a7eb23a53355ab261606ce2aa3' }
  s.platform          = :ios, "10.0"
