...
Pod::Spec.new do |s|
  ...
  s.source            = { :http => "https://kisiodigital.jfrog.io/kisiodigital/ios-release/expert/1.4.3/NavitiaSDK.framework.zip", :sha1 => '95ca6449a7ddd8ae225433b31491524823a096f5' }
  s.platform          = :ios, "10.0"
