...
Pod::Spec.new do |s|
  ...
  s.source            = { :http => "https://kisiodigital.jfrog.io/kisiodigital/ios-release/expert/1.4.3/NavitiaSDK.framework.zip", :sha1 => '42566c1a7a070fd25bb6ed30965771c29b49888c' }
  s.platform          = :ios, "10.0"
