Pod::Spec.new do |s|
  ...
  s.source  = { :http => "https://kisiodigital.jfrog.io/kisiodigital/ios-release/Expert/#{s.version}/NavitiaSDK.framework.zip", :sha1 => '38f190cfa10a74c564904a2020997a035941ed6d' }
