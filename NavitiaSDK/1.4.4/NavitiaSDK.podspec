...
Pod::Spec.new do |s|
  ...
  s.source            = { :http => "https://kisiodigital.jfrog.io/kisiodigital/ios-release/expert/1.4.4/NavitiaSDK.framework.zip", :sha1 => '0c930a0ccedb721a2e7eca7957b409a5df4af109' }
  s.platform          = :ios, "10.0"
