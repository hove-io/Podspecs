...
Pod::Spec.new do |s|
  ...
  s.source            = { :http => "https://kisiodigital.jfrog.io/kisiodigital/ios-release/expert/1.4.4/NavitiaSDK.xcframework.zip", :sha1 => 'aacc4c4d2885c065a4de117dac07e066b0a46b87' }
  s.platform          = :ios, "10.0"
