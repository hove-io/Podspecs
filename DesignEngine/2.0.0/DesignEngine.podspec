...
Pod::Spec.new do |s|
  ...
  s.source             = { :http => "https://kisiodigital.jfrog.io/artifactory/ios-release/design/2.0.0/DesignEngine.framework.zip", :sha1 => '77ad18387849b743e86fba9ed9bb7127ff23135f' }
