...
Pod::Spec.new do |s|
  ...
  s.source             = { :http => "https://kisiodigital.jfrog.io/kisiodigital/ios-release/design/1.4.2/DesignEngine.framework.zip", :sha1 => '202e4ed4374d0680e1f4e24eafc045c06e0a049b' }
  s.platform           = :ios, "10.0"
