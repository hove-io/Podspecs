Pod::Spec.new do |s|
  ...
  s.platform           = :ios, "16.0"
  s.source             = { 
    :http => "https://kisiodigital.jfrog.io/kisiodigital/ios-release/bookmark/2.4.0/BookmarkSDK.xcframework.zip", 
    :sha1 => "f03d6c149dbd98e94e2de47406143aa810ba811a"
  }

  s.dependency          'NavitiaSDK', '2.9.1'
  s.dependency          'RouterEngine', '1.7.1'
