...
Pod::Spec.new do |s|
  ...
  s.source             = { :http => "https://kisiodigital.jfrog.io/kisiodigital/ios-snapshot/partners/1.0.1-137-SNAPSHOT/NavitiaSDKPartners.framework.zip", :sha1 => 'dbc88426cd320732ab89e4188470696857f83fda' }
  s.platform           = :ios, "9.0"
