...
Pod::Spec.new do |s|
  ...
  s.source             = { :http => "https://kisiodigital.jfrog.io/kisiodigital/ios-snapshot/partners/1.0.1-137-SNAPSHOT/NavitiaSDKPartners.framework.zip", :sha1 => 'b6929cdb996807b1844b424d850b0bde5f15aed1' }
  s.platform           = :ios, "9.0"
