...
Pod::Spec.new do |s|
  ...
  s.source             = { :http => "https://kisiodigital.jfrog.io/kisiodigital/ios-snapshot/partners/1.0.1-139-SNAPSHOT/NavitiaSDKPartners.framework.zip", :sha1 => 'bc30d3379bbed7b417a4133ac8520de5f3c66a59' }
  s.platform           = :ios, "9.0"
