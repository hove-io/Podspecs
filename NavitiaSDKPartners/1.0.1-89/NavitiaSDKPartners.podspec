Pod::Spec.new do |s|
  ...
  s.source             = { :http => "https://kisiodigital.jfrog.io/kisiodigital/ios-release/partners/#{s.version}/NavitiaSDKPartners.framework.zip", :sha1 => '60ac1bba8b08ad51694c9dc8a346e09cf8fad860' }
  s.platform           = :ios, "9.0"
