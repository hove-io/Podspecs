Pod::Spec.new do |s|
  ...
  s.source             = { :http => "https://kisiodigital.jfrog.io/kisiodigital/ios-snapshot/partners/#{s.version}/NavitiaSDKPartners.framework.zip", :sha1 => '3b501c8c131a826ecee90aa72be85feb528b71f3' }
  s.platform           = :ios, "9.0"
