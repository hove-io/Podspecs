Pod::Spec.new do |s|
  ...
  s.source             = { :http => "https://kisiodigital.jfrog.io/kisiodigital/ios-snapshot/partners/#{s.version}/NavitiaSDKPartners.framework.zip", :sha1 => '79b9bb124c0369d8b259bdfdc9915cdc985b08df' }
  s.platform           = :ios, "9.0"
