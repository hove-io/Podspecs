...
Pod::Spec.new do |s|
  ...
  s.source             = { :http => "https://kisiodigital.jfrog.io/kisiodigital/$releaseOrDebug/toolbox/0.2.0-64-SNAPSHOT/Toolbox.framework.zip", :sha1 => '[33m[SDK_TEAM_CI] - Recovering Artifactory Credentials[0m' }
  s.platform           = :ios, "9.0"
