...
Pod::Spec.new do |s|
  ...
  s.source             = { :http => "https://kisiodigital.jfrog.io/kisiodigital/$releaseOrDebug/partners/9.9.9-99-SNAPSHOT/NavitiaSDKPartners.framework.zip", :sha1 => '1ad8c5519c114f9fb62808a3bc3c6ba31afbdc9d' }
  s.platform           = :ios, "9.0"
