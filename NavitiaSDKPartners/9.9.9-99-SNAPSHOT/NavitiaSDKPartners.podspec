...
Pod::Spec.new do |s|
  ...
  s.source             = { :http => "https://kisiodigital.jfrog.io/kisiodigital/$releaseOrDebug/partners/9.9.9-99-SNAPSHOT/NavitiaSDKPartners.framework.zip", :sha1 => '9d2bca6a2fc3187ec77a24c85e4e015b6d7acb84' }
  s.platform           = :ios, "9.0"
