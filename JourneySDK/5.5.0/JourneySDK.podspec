Pod::Spec.new do |s|
  ...
  s.platform           = :ios, "14.0"
  s.source             = { 
    :http => "https://kisiodigital.jfrog.io/kisiodigital/ios-release/journey/5.5.0/JourneySDK.xcframework.zip", 
    :sha1 => "4f73ccd83cc9360ba3885ec2bf63815c72367001"
  }

  s.dependency          'NavitiaSDK', '2.4.0'
  s.dependency          'RouterEngine', '1.0.0'
  s.dependency          'DesignEngine', '2.7.0'
  s.dependency          'GraphEngine', '1.0.2'
