Pod::Spec.new do |s|
  ...
  s.platform           = :ios, "13.0"
  s.source             = { 
    :http => "https://kisiodigital.jfrog.io/kisiodigital/ios-release/journey/5.4.7/JourneySDK.xcframework.zip", 
    :sha1 => "d0a555b1ed3d57b9f3454bc59d0903b7cd91e8e3"
  }
  ...
  s.dependency          'BookmarkSDK', '1.2.2'
