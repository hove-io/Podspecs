...
Pod::Spec.new do |s|
  ...
  s.source             = { :http => "https://kisiodigital.jfrog.io/kisiodigital/ios-release/journey/3.8.4/JourneySDK.framework.zip", :sha1 => "464b2ef8fc80ffb3decb274c563d65ab02bd9836" }
  s.platform            = :ios, "10.0"
