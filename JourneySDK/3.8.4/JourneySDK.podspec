...
Pod::Spec.new do |s|
  ...
  s.source             = { :http => "https://kisiodigital.jfrog.io/kisiodigital/ios-release/journey/3.8.4/JourneySDK.framework.zip", :sha1 => "639dfffb759684c30bcd2a37b43d4ec902f91615" }
  s.platform            = :ios, "10.0"
