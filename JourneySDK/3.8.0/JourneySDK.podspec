...
Pod::Spec.new do |s|
  ...
  s.source              = { :http => "https://kisiodigital.jfrog.io/kisiodigital/ios-release/journey/3.8.0/JourneySDK.framework.zip", :sha1 => 'e8ce4665bef712ae3bc6195d5f36f25241a79891' }
  s.platform            = :ios, "10.0"
