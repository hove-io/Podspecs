...
Pod::Spec.new do |s|
  ...
  s.source              = { :http => "https://kisiodigital.jfrog.io/kisiodigital/ios-release/journey/3.8.2/JourneySDK.framework.zip", :sha1 => '9e6d403ca942525127951d3d5a1ae4403f6f69dcbc62f4abfd422f77edb61c25' }
  s.platform            = :ios, "10.0"
