Pod::Spec.new do |s|
  ...
  s.platform           = :ios, "14.0"
  s.source             = { 
    :http => "https://kisiodigital.jfrog.io/kisiodigital/ios-release/journey/5.7.0/JourneySDK.xcframework.zip", 
    :sha1 => "8bc9c72ea2000db22c6c64e275192d30d8e57785"
  }

  s.dependency          'NavitiaSDK', '2.6.0'
  s.dependency          'RouterEngine', '1.1.1'
  s.dependency          'DesignEngine', '2.9.0'
  s.dependency          'GraphEngine', '1.0.5'
