...
Pod::Spec.new do |s|
  ...
  s.source              = { :http => "https://kisiodigital.jfrog.io/kisiodigital/ios-release/journey/3.8.3/JourneySDK.framework.zip", :sha1 => '7ed4490a72530237afaee3cd0524dbd0b92125be' }
  s.platform            = :ios, "10.0"
