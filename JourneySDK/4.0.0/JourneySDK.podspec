...
Pod::Spec.new do |s|
  ...
  s.source             = { :http => "https://kisiodigital.jfrog.io/kisiodigital/ios-release/journey/4.0.0/JourneySDK.framework.zip", :sha1 => "0eff54fa87f1bce2cf70fc8c681253301bce3410" }
  s.platform            = :ios, "10.0"
