...
Pod::Spec.new do |s|
  ...
  s.source             = { :http => "https://kisiodigital.jfrog.io/kisiodigital/ios-release/journey/4.0.0/JourneySDK.framework.zip", :sha1 => "427b304947bc20468de9530fe5032ad62e02ccdc" }
  s.platform            = :ios, "10.0"
