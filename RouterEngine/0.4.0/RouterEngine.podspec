...
Pod::Spec.new do |s|
  ...
  s.source             = { :http => "https://kisiodigital.jfrog.io/kisiodigital/ios-release/router/0.4.0/RouterEngine.framework.zip", :sha1 => '602707a715600c5a2b3ed421fbe2f0f073169fe7' }
  s.platform           = :ios, "10.0"
