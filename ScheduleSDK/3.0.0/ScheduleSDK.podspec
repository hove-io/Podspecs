...
Pod::Spec.new do |s|
  ...
  s.source             = { :http => "https://kisiodigital.jfrog.io/kisiodigital/ios-release/schedule/3.0.0/ScheduleSDK.framework.zip", :sha1 => "d196837d2784f6795d17598748b7bbb194e5432a" }

  s.dependency         'BookmarkEngine', '1.0.0'
