...
Pod::Spec.new do |s|
  ...
  s.source             = { :http => "https://kisiodigital.jfrog.io/kisiodigital/ios-release/schedule/1.1.0/ScheduleSDK.framework.zip", :sha1 => 'd203ab09f1c55f37746ecc2f75e80780e5d6e0f3' }
  s.platform           = :ios, "10.0"
