Pod::Spec.new do |s|
  ...
  s.source             = { :http => "https://kisiodigital.jfrog.io/kisiodigital/ios-release/collect/#{s.version}/Collect.framework.zip", :sha1 => 'e2b272218674ce3b2e1e49745ae3e27dd415db17' }
  s.platform           = :ios, "9.0"
