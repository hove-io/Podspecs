Pod::Spec.new do |s|
  ...
  s.source             = { :http => "https://kisiodigital.jfrog.io/kisiodigital/ios-release/collect/#{s.version}/Collect.framework.zip", :sha1 => '2c21060f67669d93e801345ebe1a600414aafc64' }
  s.platform           = :ios, "9.0"
