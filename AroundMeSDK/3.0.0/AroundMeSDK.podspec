...
Pod::Spec.new do |s|
  ...
  s.source             = { :http => "https://kisiodigital.jfrog.io/kisiodigital/ios-release/aroundme/3.0.0/AroundMeSDK.framework.zip", :sha1 => "cb4fe46d592557e24fcfb283180ef7f6ab4ebce0" }
