...
Pod::Spec.new do |s|
  ...
  s.source              = { :http => "https://kisiodigital.jfrog.io/kisiodigital/ios-snapshot/bookTicket/0.5.0-63-SNAPSHOT/BookTicketSDK.framework.zip", :sha1 => '0bf06d70eb07578edd52bec955bdcb05bf8e153c' }
  s.platform            = :ios, "9.0"
