...
Pod::Spec.new do |s|
  ...
  s.source              = { :http => "https://kisiodigital.jfrog.io/kisiodigital/ios-snapshot/bookTicket/0.6.0-95-SNAPSHOT/BookTicketSDK.framework.zip", :sha1 => '50ede6dc823b853126a7839ab60136de36090aa7' }
  s.platform            = :ios, "9.0"
