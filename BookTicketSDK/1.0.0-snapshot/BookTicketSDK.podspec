Pod::Spec.new do |spec|
  ...
  spec.source              = { :http => "https://kisiodigital.jfrog.io/kisiodigital/ios-snapshot/bookTicket/#{spec.version}/BookTicketSDK.framework.zip", :sha1 => '1996f9bee771b955cc82cdcfe93d712164201982' }
