Pod::Spec.new do |spec|
  ...
  spec.source              = { :http => "https://kisiodigital.jfrog.io/kisiodigital/ios-snapshot/bookTicket/#{spec.version}/BookTicketSDK.framework.zip", :sha1 => '9b28078381cf3a36abefd631a679eb4a5eaaab4b' }
