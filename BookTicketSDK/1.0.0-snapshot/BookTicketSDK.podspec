Pod::Spec.new do |spec|
  ...
  spec.source              = { :http => "https://kisiodigital.jfrog.io/kisiodigital/ios-snapshot/bookTicket/#{spec.version}/BookTicketSDK.framework.zip", :sha1 => 'f6b02892ddad21df93762204a58fe0c185e7ca25' }
