Pod::Spec.new do |spec|
  ...
  spec.source              = { :http => "https://kisiodigital.jfrog.io/kisiodigital/ios-snapshot/bookTicket/#{spec.version}/BookTicketSDK.framework.zip", :sha1 => 'cf9f7deb741e7380ae5040d5e70c39cf68cc35f8' }
