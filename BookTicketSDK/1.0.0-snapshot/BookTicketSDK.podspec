Pod::Spec.new do |spec|
  ...
  spec.source              = { :http => "https://kisiodigital.jfrog.io/kisiodigital/ios-snapshot/bookTicket/#{spec.version}/BookTicketSDK.framework.zip", :sha1 => '2f5d7d04a7a9b7512057ad5fc4d5511d2086815c' }
