...
Pod::Spec.new do |s|
  ...
  s.source              = { :http => "https://kisiodigital.jfrog.io/kisiodigital/ios-release/journey/3.4.1/NavitiaSDKUI.framework.zip", :sha1 => '1d815b652f7eac7af5c25e19c9586c1868c1aa31' }
  s.platform            = :ios, "10.0"
