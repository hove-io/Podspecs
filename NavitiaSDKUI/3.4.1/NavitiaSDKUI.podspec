...
Pod::Spec.new do |s|
  ...
  s.source              = { :http => "https://kisiodigital.jfrog.io/kisiodigital/ios-release/journey/3.4.1/NavitiaSDKUI.framework.zip", :sha1 => '333a140bd2a3395e69f49e60b28e474455a3a216' }
  s.platform            = :ios, "10.0"
