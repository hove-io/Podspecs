...
Pod::Spec.new do |s|
  ...
  s.source              = { :http => "https://kisiodigital.jfrog.io/kisiodigital/ios-release/journey/3.1.0/NavitiaSDKUI.framework.zip", :sha1 => '7c8bb7a94b10c8bccb7f8e66761b9985b793330e' }
  s.platform            = :ios, "10.0"
