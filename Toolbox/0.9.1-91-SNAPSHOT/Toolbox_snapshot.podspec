...
Pod::Spec.new do |s|
  ...
  s.source             = { :http => "https://kisiodigital.jfrog.io/kisiodigital/ios-snapshot/toolbox/0.9.1-91-SNAPSHOT/Toolbox.framework.zip", :sha1 => 'b04f3ee8f5e43fa3b162981b50bb72fe1acabb33' }
  s.platform           = :ios, "9.0"
