...
Pod::Spec.new do |s|
  ...
  s.source             = { :http => "https://kisiodigital.jfrog.io/kisiodigital/ios-snapshot/toolbox/0.2.0-69-SNAPSHOT/Toolbox.framework.zip", :sha1 => '746d1eaa89a24809cf00c90d832a603ba187925e' }
  s.platform           = :ios, "9.0"
