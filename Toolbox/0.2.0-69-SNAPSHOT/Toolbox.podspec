...
Pod::Spec.new do |s|
  ...
  s.source             = { :http => "https://kisiodigital.jfrog.io/kisiodigital/ios-snapshot/toolbox/0.2.0-69-SNAPSHOT/Toolbox.framework.zip", :sha1 => 'e5082abf91ca677b6be192988759e0f9ebdaf6fd' }
  s.platform           = :ios, "9.0"
