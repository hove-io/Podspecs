Pod::Spec.new do |s|
  ...
  s.source             = { :http => "https://kisiodigital.jfrog.io/kisiodigital/ios-release/toolbox/#{s.version}/Toolbox.framework.zip", :sha1 => 'b68e2d8621f718783ec4bee95e99a7d7b1a5a3e4' }
  s.platform           = :ios, "9.0"
