Pod::Spec.new do |s|
  ...
  s.source             = { :http => "https://kisiodigital.jfrog.io/kisiodigital/ios-snapshot/toolbox/#{s.version}/Toolbox.framework.zip", :sha1 => '2bc055c95c14bc047389405fd9cca77b9a06b6fc' }
  s.platform           = :ios, "9.0"
