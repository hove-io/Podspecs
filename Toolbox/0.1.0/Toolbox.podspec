Pod::Spec.new do |s|
  ...
  s.source             = { :http => "https://kisiodigital.jfrog.io/kisiodigital/ios-release/toolbox/#{s.version}/Toolbox.framework.zip", :sha1 => '48eb93fef58e0bc3cf7f820640b2442a7d4c7b8c' }
  s.platform           = :ios, "9.0"
