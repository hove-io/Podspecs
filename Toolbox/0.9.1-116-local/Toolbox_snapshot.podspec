...
Pod::Spec.new do |s|
  ...
  s.version            = '0.9.1-116-local'
  s.swift_version      = '5.0'
  s.summary            = "Toolbox SDK for Kisio"
  s.homepage           = "https://github.com/CanalTP/toolbox_ios"
  s.license            = "License"
  s.author             = { "SDK Team" => "team.sdk@kisio.com" }
  s.source             = { :http => "https://kisiodigital.jfrog.io/kisiodigital/ios-snapshot/toolbox/0.9.1-116-local/Toolbox.framework.zip", :sha1 => '49486d29224c78504dbb497d099d694aeace5c4a' }
  s.platform           = :ios, "9.0"
