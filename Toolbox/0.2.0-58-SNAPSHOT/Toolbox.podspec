Pod::Spec.new do |s|
  ...
  s.source             = { :http => "https://kisiodigital.jfrog.io/kisiodigital/ios-snapshot/toolbox/#{s.version}/Toolbox.framework.zip", :sha1 => 'fe66f05ce4cef6606be713ee11588728f20d122b' }
  s.platform           = :ios, "9.0"
