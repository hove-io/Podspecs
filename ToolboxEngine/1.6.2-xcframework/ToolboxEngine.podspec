Pod::Spec.new do |s|
  ...
  s.source             = { :http => "https://kisiodigital.jfrog.io/kisiodigital/ios-release/toolbox/1.6.2/ToolboxEngine.xcframework.zip", :sha1 => "5f7c9c7d96543de52013eeed0e50f8e47fc60834" }
  s.platform           = :ios, "13.0"
