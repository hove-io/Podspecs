Pod::Spec.new do |s|
  ...
  s.source             = { :http => "https://kisiodigital.jfrog.io/kisiodigital/ios-release/toolbox/1.5.0/ToolboxEngine.framework.zip", :sha1 => '6694ee8638cce79bad06416991f44d2d5a823cf7' }
  s.platform           = :ios, "10.0"
